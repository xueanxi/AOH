...
public class SkillTest {
    ...
    public void TestSkillAttackRangeLevelUp() {
        ...
        LogUtils.d(TAG,"skill range1 = "+skill.getRange() + "每级提升距离"+skill.getLevelUpRange());

        skill= new SkillBattle(baseSkill,5);
        LogUtils.d(TAG,"skill range2 = "+skill.getRange()+"每级提升距离"+ skill.getLevelUpRange());
    }
    ...
    public void TestSkillCDLevelUp() {
        ...
        SkillBattle skill = new SkillBattle(baseSkill,1);
        LogUtils.d(TAG,"skill cd = "+skill.getCdTime() + "每级减低CD"+skill.getLevelUpCDTime());
    ...
    public void testSkill(String personName2, int skillId, int skillLevel) {
        ...
        // 初始化阵型2
        FormationBase lineUp2 = FormationManager.getDataFromDataBaseById(0);//普通阵容
