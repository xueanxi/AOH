...
public class ActiveValueModel implements Runnable {
    ...
    public ActiveValueModel(BattleEngine battleEngine, ArrayList<BattlePerson> personLists) {
        ...
        while (!isOver) {
            ...
            while (personMaxActive != null && personMaxActive.size() > 0) {
                ...
                if (personMaxActive.size() >= 1) {
                    ...
                    // 一个人物进攻完了之后，需要检查其他蓄气满的人生命值是否健康，如果不健康，需要移除。
