package com.game.xianxue.aoh.game.model.constant;
...
public class ConstantColumn {
    ...
    public static class BuffColumn{
        ...
        public static final String superposition = "superposition";     // buff是否叠加（0：只触发一次，1：每回合不断触发）
     ...
     *  阵型 数据库表格的 列属性
     */
    public static class FormationColumn {
        public static final String tableName = "formation";
        public static final String id = "_id";                          // 数据库id
        public static final String formation_id = "formation_id";             // 唯一标识这个阵型的id
        public static final String name = "name";                       // 名字
        public static final String introduce = "introduce";             // 介绍
        public static final String max_person = "max_person";           // 容纳最大人数
        public static final String formation_json = "formation_json";   // 具体阵型的json字符串
