...
public class BattlePerson extends NormalPerson {
    ...
    private ILineUp lineUp;        // 阵型的接口

    ArrayList<BuffEffectBattle> activeBuffList = null; // 主动加持的buff(指战斗中，使用技能加持的)
    ...
    public BattlePerson(NormalPerson person, int camp) {
        // 原始资料
        this.personId = person.getPersonId();                 // id唯一标识这个人物
        this.name = person.getName();                           // 名字
        this.namePinyin = person.getNamePinyin();                         // 名字拼音
    ...
    private void calculateBaseAttributeFormActiveBuffList() {
        ...
        // 通过for循环来处理每一个buff
        for (BuffEffectBattle buff : activeBuffList) {
     ...
     * @param buff
     */
    public void addBuff(BuffEffectBattle buff) {
        if (activeBuffList == null) {
            activeBuffList = new ArrayList<BuffEffectBattle>();
        }
     ...
     * @param buff
     */
    public void addBuffInBattle(BuffEffectBattle buff) {
        if (activeBuffList == null) {
            activeBuffList = new ArrayList<BuffEffectBattle>();
        }
    ...
    public ArrayList<BuffEffectBattle> getActiveBuffList() {
        return activeBuffList;
    }

    public void setActiveBuffList(ArrayList<BuffEffectBattle> activeBuffList) {
    ...
    public void setLineUp(ILineUp lineUp) {
        this.lineUp = lineUp;
    }
    ...
    public void displaySkill(){
        ...
        BattleLog.log(TAG_SA,getName() + "技能列表：" + skillStrings.toString());
    }
}
