package com.game.xianxue.aoh.game.skill;
...
public class SkillBattle extends SkillBase implements ISkill {
    ...
    public void setLevel(int level) {
        ...
        //LogUtils.d(TAG,"setStartLevel before:"+this.name+" number= "+effectNumber);
    }
